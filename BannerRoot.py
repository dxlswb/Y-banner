...
sleep 1                                                                                                                                                                          echo -e "$red(gem)$nc No instalado [$red✗$nc]"
sleep 1
...
clear
toilet -f big "BannerRoot"  -F gay | lolcat
sleep 1
echo -e "$purple(*)$blue Created by$red dxlswb"
sleep 2
...
PS1='\$ '
" >> /data/data/com.termux/files/usr/etc/bash.bashrc
echo -e "$purple(*)$red Desea agregar un audio de bienvenida al inicio?"
sleep 2
audioconfirm
;;

*)
echo -e "$purple(ERROR)$red $REPLY$WHITE OPCION NO VALIDA"
;;
esac
done
